# -*- coding: utf-8 -*-
"""Automatizacion_reportes_financieros.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TLRCi44gTo_ECqIgLFc4a5VHTCqKgLdK
    ...
    try:
        respuesta = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"¿Cuál es el símbolo bursátil (ticker) de la empresa {nombre_empresa} que cotiza en bolsa en el mercado estadounidense?"}
            ],
            max_tokens=5,
            temperature=0,
            n=1,
